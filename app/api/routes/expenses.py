...
def create_expense(
    ...
    db.commit()
    db.refresh(expense)
    return JSONResponse(content={"message": "Expense created successfully"}, status_code=201)
...
def update_expense(
    ...
    db.commit()
    db.refresh(expense)
    return JSONResponse(content={"message": "Expense updated successfully"}, status_code=200)
